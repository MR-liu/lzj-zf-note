...
const list = [
  ...
  'http://img.zhufengpeixun.cn/download.jpg',
  'http://img.zhufengpeixun.cn/downloadlist.jpg',
  ...
  'http://img.zhufengpeixun.cn/run1.jpg',
  'http://img.zhufengpeixun.cn/run2.jpg',
  'http://img.zhufengpeixun.cn/run3.jpg',
  'http://img.zhufengpeixun.cn/node版本.jpg',
  'http://img.zhufengpeixun.cn/run4.jpg',
  'http://img.zhufengpeixun.cn/run5.jpg',
  'http://nimit.io/images/n/n.gif',
  'http://img.zhufengpeixun.cn/bits.jpg',
  ...
  'http://img.zhufengpeixun.cn/shake8.jpg',
  'http://img.zhufengpeixun.cn/datatransfer8.jpg',
  ...
  'http://img.zhufengpeixun.cn/treeindex.jpg',
  'http://img.zhufengpeixun.cn/mysqlexplain.jpg',
  'http://img.zhufengpeixun.cn/ast.jpg',
  ...
  'http://img.zhufengpeixun.cn/usercore.jpg',
  ...
  'https://www.fullstackjavascript.cn/mvc.png',
  'https://www.fullstackjavascript.cn/mvvm.png',
  ...
  'http://img.zhufengpeixun.cn/websocketframe.jpg',
  ...
  'http://img.zhufengpeixun.cn/logic.jpg',
  'http://img.zhufengpeixun.cn/point.jpg',
...
const streamImg = (imgURL, fn) => {
  try {
    request(imgURL, () => {
      ...
      .pipe(fs.createWriteStream(`./${getName(imgURL)}`))
      .on('finish', () => {
        console.error('写入已完成');
        // eslint-disable-next-line no-unused-expressions
        fn && fn();
...
function get() {
  ...
  streamImg(imgURL, () => {
    if (i > list.length) return console.log('all ====> over');
    i += 1;
    return get();
  });
}
